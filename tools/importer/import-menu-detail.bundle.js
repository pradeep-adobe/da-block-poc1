var CustomImportScript = (() => {
  ...
  // tools/importer/import-menu-detail.js
  var import_menu_detail_exports = {};
  __export(import_menu_detail_exports, {
    default: () => import_menu_detail_default
  });
  ...
  var import_menu_detail_default = {
    transform: (payload) => {
  ...
  return __toCommonJS(import_menu_detail_exports);
})();

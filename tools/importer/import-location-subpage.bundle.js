var CustomImportScript = (() => {
  ...
  // tools/importer/import-location-subpage.js
  var import_location_subpage_exports = {};
  __export(import_location_subpage_exports, {
    default: () => import_location_subpage_default
  });
  ...
  var import_location_subpage_default = {
    transform: (payload) => {
  ...
  return __toCommonJS(import_location_subpage_exports);
})();

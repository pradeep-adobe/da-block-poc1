var CustomImportScript = (() => {
  ...
  // tools/importer/import-location-roastery.js
  var import_location_roastery_exports = {};
  __export(import_location_roastery_exports, {
    default: () => import_location_roastery_default
  });
  ...
  var PAGE_TEMPLATE = {
    name: "location-roastery",
    blocks: [
      {
        name: "cards-feed",
        instances: [".section_featured-feed .feed_list"]
      },
      {
        name: "cards-location",
  ...
  var import_location_roastery_default = {
    transform: (payload) => {
  ...
  return __toCommonJS(import_location_roastery_exports);
})();

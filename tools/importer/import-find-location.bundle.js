var CustomImportScript = (() => {
  ...
  // tools/importer/import-find-location.js
  var import_find_location_exports = {};
  __export(import_find_location_exports, {
    default: () => import_find_location_default
  });
  ...
  var import_find_location_default = {
    transform: (payload) => {
  ...
  return __toCommonJS(import_find_location_exports);
})();
